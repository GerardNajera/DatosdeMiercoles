...
a<-ggplot(datos_uip_sinNA, aes(x=camara, y=porcentaje_mujeres, 
                        fill=cuota_genero)) +geom_boxplot() +labs(title="Mujeres en Política",x="Cámara", y = "Porcentaje de mujeres en esa cámara")+scale_fill_manual(values= c("#4271AE","#56B4E9"))+theme_minimal()
